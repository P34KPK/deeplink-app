        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-gray-500 ml-1 mb-1 block">Description</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-xs text-gray-500 ml-1 mb-1 block">Custom Alias (Optional)</label>
                <input
                  type="text"
