...
export default function UserBioPage() {
    ...
    return (
        <div className={`min-h-screen flex flex-col items-center relative overflow-hidden font-sans transition-colors duration-500 ${isDark ? 'bg-zinc-950 text-white' : 'bg-zinc-50 text-zinc-900'}`}>
            ...
            <div className={`w-full max-w-lg relative z-10 flex flex-col min-h-screen backdrop-blur-sm border-x shadow-2xl transition-colors duration-500 ${isDark ? 'bg-zinc-950/50 border-white/5' : 'bg-white/50 border-zinc-200/50'}`}>
